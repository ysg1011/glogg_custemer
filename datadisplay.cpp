 ...
 */
void DataDisplay::setupTextFormats(QFont *sample_font)
{
...
void DataDisplayPrivate::setDisplayTime(bool displayTime)
{
    if (displayTime) {
        ...
        m_time_width = 3 + metric->horizontalAdvance(QStringLiteral("00:00:00:000"));
    } else {
        m_time_width = 0;
    }
